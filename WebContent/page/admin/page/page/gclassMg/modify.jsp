...
<div id="right_font">
	...
	<table class="table">
		...
		<input type="hidden" name="id" value="${gclassBean.id }" />
		<tr>
			<th style="width:30px;">商品分类名称</th>
			<td style="width:150px;"><input style="width:90%" type="text" name="name" value="${gclassBean.name }"/></th>
		</tr>
		<tr>

	...
	<div class="centerNum20150618">
		<ul>
			...
			<li class="goods_content">		
				<div class="g_info" onclick="location.href='showGoodsMenuAction.action?id=${goodsBean.id}';">
					<table>
						<tr>
							<td width=1><img src="${path }${goodsBean.image}" /></td>
							<td>
								<span class="s_name">${goodsBean.name }</span>
								<span class="money">￥${goodsBean.price }元</span>
								<br /><br />
							</td>
						</tr>
					</table>

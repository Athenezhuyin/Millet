...
<div id="login_info">
	<div class="info">一个账号，玩转小米服务</div>
		<div class="win">
			<form action="showUserLoginAction.action" method="post" id="form">
			<table width="100%" border=1>
				<tr>
					<td style="border:1px solid #d4d4d3;border-style:none none solid none;"><input type="text" name="phone" class="io" value="1234560"/>					
				</tr>
				<tr>
					<td><input type="password" name="pwd" class="io" value="123456"/></td>
				</tr>
	...
	<br />
	<input class="but" type="submit" name="send" value="立即登陆" onclick="login();"/>
	</center>
	<br /><br /><br />
	<center>
	<input class="but_reg" type="button" value="注册小米账号" onclick="window.location.href='reg.jsp'"/>
	</center>
</div>
</body>
</html>

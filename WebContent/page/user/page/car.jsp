...
<div id="goods_list">
	<div class="centerNum20150618">
		<ul>
			<c:forEach items="${list }" var="carBean">
			<li class="goods_content">		
				<div class="g_info">
					<table width="100%">
						<tr>
							<td width=1><img src="${path }${carBean.image}" /></td>
							<td>
								<span class="s_name">${carBean.name}</span><br />
								<span class="money">售价：${carBean.price }元</span>
								<br /><br />
								<table width="100%">
								<tr>
									<td>
										<div class="delete">
											<div class="number">
												<table>
													<tr>
														<td><a class="snum t01" href="carModifyAction.action?goods_id=${carBean.goods_id }&&n=-1">-</a></td>
														<td><input class="snum t02" type="text" value="${carBean.number }" /></td>
														<td><a class="snum t03" href="carModifyAction.action?goods_id=${carBean.goods_id }&&n=1">+</a></td>
													</tr>
												</table>
											</div>
											<div class="cl">
												<a href="carDeleteAction.action?goods_id=${carBean.goods_id }">删</a>
											</div>
										</div>
									</td>
								</tr>
	...
	<div class="s_js">
		<table width="100%">
			<tr>
				<td style="padding-left:1em;"><span class="js_jz">应付金额：${sum==null?0:sum}元</span></td>
				<td width=1 style="padding-right:1em;"><div class="js_ok" onclick="window.location.href='showCarGordersAction.action'">结算</div></td>
			</tr>
		</table>

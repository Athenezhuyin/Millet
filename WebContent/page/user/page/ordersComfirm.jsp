...
<div id="user_dd">
	<form action="./addr/addrAddAction.action" method="get" onsubmit="return isPost();">
		<div class="dd_center">
			<input type="hidden" name="orders_id" value="<%=request.getParameter("orders_id") %>"/>
...
<script type="text/javascript">
	...
	function getProvince(){
		 ...
		 xmlHttpRequest.open("get","./addr/jLAction.action?method=province");
	...
	function getCity(){
		 var xmlHttpRequest = new XMLHttpRequest();
		 xmlHttpRequest.open("get","./addr/jLAction.action?method=city&&id="+document.getElementById("province").value);
		 xmlHttpRequest.onreadystatechange = function(){
			 if(xmlHttpRequest.readyState==4 && xmlHttpRequest.status==200){
				 var data = eval(xmlHttpRequest.responseText);
				 var arr = [];
	...
	function getDistrict(){
		var xmlHttpRequest = new XMLHttpRequest();
		 xmlHttpRequest.open("get","./addr/jLAction.action?method=district&&id="+document.getElementById("city").value);
		 xmlHttpRequest.onreadystatechange = function(){
			 if(xmlHttpRequest.readyState==4 && xmlHttpRequest.status==200){
				 var data = eval(xmlHttpRequest.responseText);
				 var arr = [];
